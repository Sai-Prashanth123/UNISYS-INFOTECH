...
import { Lock, Eye, EyeOff, CheckCircle, XCircle, Loader2, ArrowLeft, KeyRound, Shield, ShieldCheck } from 'lucide-react';

/**
 * Admin Reset Password Page
 * Same Supabase Auth flow as ResetPasswordPage but:
 * - Admin-specific branding (purple/shield icons)
 * - All links redirect to /login/admin instead of /login/employee
 * - After success, redirects to admin login
 */
export const AdminResetPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Sync to custom users table (critical for login)
      try {
        ...
        if (user?.email && session?.access_token) {
          ...
          console.log('Backend password sync successful');
        }
      } catch (syncError) {
        ...
        try {
          ...
          toast.warn('Password updated but may not sync. Contact support if login fails.');
        }
      }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0a1628] via-[#0f1d35] to-[#0a1628] p-4">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Verifying admin reset link...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0a1628] via-[#0f1d35] to-[#0a1628] p-4">
        <div className="w-full max-w-md">
          <div className="bg-[#1a2942]/80 backdrop-blur-xl border border-green-900/30 rounded-2xl p-8 shadow-2xl text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Admin Password Reset Successful!</h2>
            <p className="text-slate-400 mb-6">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1a2942]/80 backdrop-blur-xl border border-purple-900/30 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Reset Admin Password</h1>
            {userEmail && (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-slate-800/50 border border-purple-900/50 rounded-lg text-white placeholder-slate-500 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 bg-slate-800/50 border rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all ${
            ...
            <button
              ...
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-purple-500/25 mt-6"
            >
              {loading ? (
                <>
